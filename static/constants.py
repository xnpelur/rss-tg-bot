class Messages:
    ...
    SOURCE_ALREADY_EXISTS = "Данный источник уже есть в списке"
    REMOVING_SOURCE = "Для удаления источника выберите его номер из списка ниже:"
    REMOVING_SOURCE_SUCCESS = "Источник удален успешно"
